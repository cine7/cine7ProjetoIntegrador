...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:DataList ID="DataList1" runat="server" DataSourceID="ObjectDataSource2">
        <ItemTemplate>
            <asp:Image ID="Image5" runat="server" ImageUrl='<%# Eval("caminhoImagem") %>' Width="20px" Height="30px" />
            <br />
            <asp:LinkButton ID="LinkButtonFilme_name" runat="server" ForeColor="Black"  onMouseOver="mudar('LinkButtonFilme_name') "OnClick="LinkButtonfilme_name_Click1" Text='<%# Eval("filme_name") %>'></asp:LinkButton>

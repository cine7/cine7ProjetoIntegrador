...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="clearfix" style="position: relative; left: 525px; width:261px; top: 0px;">
                                ...
                                <caption>
                                    ...
                                    <tr>
                                        ...
                                        <td style="position: relative; bottom: -4px">
                                            <asp:TextBox ID="UserName" runat="server" Height="25px" Width="200px"></asp:TextBox><br />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="Password" runat="server" Height="25px" TextMode="Password" Width="200px"></asp:TextBox>

...
namespace ProjetoGrupo6.UsuarioNormal
{
    public partial class Filme : System.Web.UI.Page
    {
        ...
        protected void ImageButtonEstrela1_Click(object sender, ImageClickEventArgs e)
        {
            ...
            aSQL.CommandText = "Select dataHora FROM RelacaoFavorito where filme_id = @filme_id and usuario = @usuario";
            aSQL.Parameters.AddWithValue("@filme_id", int.Parse(LabelFilme_id.Text));
            ...
            if (dr.HasRows)
            {
                while (dr.Read()) // Le o proximo registro
                {
                    ...
                    if (dr["dataHora"] != null)
                    {
                        aSQL.CommandText = "INSERT INTO RelacaoAvaliacao(filme_id, usuario, avaliacao) VALUES (@filme_id, @usuario, 1)";
                        aSQL.Parameters.AddWithValue("@filme_id", int.Parse(LabelFilme_id.Text));
                        aSQL.Parameters.AddWithValue("@usuario", Session["usuario"].ToString());
                    }
                    else
                    {
                        aSQL.CommandText = "UPDATE FROM RelacaoAvaliacao set avaliacao = 1 WHERE filme_id = @filme_id and usuario = @usuario)";
                        aSQL.Parameters.AddWithValue("@filme_id", int.Parse(LabelFilme_id.Text));
                        aSQL.Parameters.AddWithValue("@usuario", Session["usuario"].ToString());
                    }
                }
        ...
        protected void ImageButtonEstrela2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            // Executando o comando
            SqlCommand aSQL = new SqlCommand("INSERT INTO RelacaoAvaliacao(filme_id, usuario, avaliacao) VALUES (@filme_id, @usuario, 2)", aSQLCon);
            aSQL.Parameters.AddWithValue("@filme_id", int.Parse(LabelFilme_id.Text));
            aSQL.Parameters.AddWithValue("@usuario", Session["usuario"].ToString());
            aSQL.ExecuteNonQuery();
        }
        ...
        protected void ImageButtonEstrela3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            // Executando o comando
            SqlCommand aSQL = new SqlCommand("INSERT INTO RelacaoAvaliacao(filme_id, usuario, avaliacao) VALUES (@filme_id, @usuario, 3)", aSQLCon);
            aSQL.Parameters.AddWithValue("@filme_id", int.Parse(LabelFilme_id.Text));
            aSQL.Parameters.AddWithValue("@usuario", Session["usuario"].ToString());
            aSQL.ExecuteNonQuery();
        }
        ...
        protected void ImageButtonEstrela4_Click(object sender, ImageClickEventArgs e)
        {
            ...
            // Executando o comando
            SqlCommand aSQL = new SqlCommand("INSERT INTO RelacaoAvaliacao(filme_id, usuario, avaliacao) VALUES (@filme_id, @usuario, 4)", aSQLCon);
            aSQL.Parameters.AddWithValue("@filme_id", int.Parse(LabelFilme_id.Text));
            aSQL.Parameters.AddWithValue("@usuario", Session["usuario"].ToString());
            aSQL.ExecuteNonQuery();
        }
        ...
        protected void ImageButtonEstrela5_Click(object sender, ImageClickEventArgs e)
        {
            ...
            // Executando o comando
            SqlCommand aSQL = new SqlCommand("INSERT INTO RelacaoAvaliacao(filme_id, usuario, avaliacao) VALUES (@filme_id, @usuario, 5)", aSQLCon);
            aSQL.Parameters.AddWithValue("@filme_id", int.Parse(LabelFilme_id.Text));
            aSQL.Parameters.AddWithValue("@usuario", Session["usuario"].ToString());
            aSQL.ExecuteNonQuery();
        }
        ...
        protected void ImageButtonEstrela6_Click(object sender, ImageClickEventArgs e)
        {
            ...
            // Executando o comando
            SqlCommand aSQL = new SqlCommand("INSERT INTO RelacaoAvaliacao(filme_id, usuario, avaliacao) VALUES (@filme_id, @usuario, 6)", aSQLCon);
            aSQL.Parameters.AddWithValue("@filme_id", int.Parse(LabelFilme_id.Text));
            aSQL.Parameters.AddWithValue("@usuario", Session["usuario"].ToString());
            aSQL.ExecuteNonQuery();
        }
        ...
        protected void ImageButtonEstrela7_Click(object sender, ImageClickEventArgs e)
        {
            ...
            // Executando o comando
            SqlCommand aSQL = new SqlCommand("INSERT INTO RelacaoAvaliacao(filme_id, usuario, avaliacao) VALUES (@filme_id, @usuario, 7)", aSQLCon);
            aSQL.Parameters.AddWithValue("@filme_id", int.Parse(LabelFilme_id.Text));
            aSQL.Parameters.AddWithValue("@usuario", Session["usuario"].ToString());
            aSQL.ExecuteNonQuery();
        }

...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="LabelFilme_id" runat="server" Text="Label" Visible="False"></asp:Label>
        ...
        <asp:ImageButton ID="ImageButtonVisto" runat="server" Height="43px" ImageUrl="~/Imagens/vistoButton.jpg" OnClick="ImageButtonVisto_Click" />
&nbsp;
    <asp:ImageButton ID="ImageButtonInteresse" runat="server" Height="45px" ImageUrl="~/Imagens/tvInteresseButton.jpg" OnClick="ImageButtonInteresse_Click" Width="48px" />
        <br />
        <br />
